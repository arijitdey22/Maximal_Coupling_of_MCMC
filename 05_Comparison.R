...
# save(store.algo.2, store.algo.3, file = "05_Comparison.i.1.Rdata")
save(store.algo.2, store.algo.3, file = "05_Comparison.c.1.Rdata")
# 
...
# 
#     #aesthetics
#     print(paste0("We are at d = ", d.vec[i.d],", and rep = ", reps))
# 
